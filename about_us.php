...
<h1>
  <center> TRANSPORT MANAGEMENT SYSTEM</center>
</h1>
<style type="text/css">
  h1 {
    color: blue;
...
<body background="a.jpg">
  ...
  <div id="news">
    <hr>
    <h2 id="h1" style="color: black">
      <center>About Us</center>
    </h2>
    <hr>
    <marquee direction="up" align="right">
      <h2 style="text-align:center ">The objective of this application is to automate the details of transportation
        ...
        informations.The purpose to design the system that allows search and retrive related data easily..</h2>
    </marquee>
    <hr>
    <hr>
  </div>
